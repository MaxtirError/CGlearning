...
void MainWindow::CreateActions()
{
	...
	connect(action_fill_, SIGNAL(triggered()), this, SLOT(Fill()));

	action_move_ = new QAction(tr("Move"), this);
	connect(action_move_, SIGNAL(triggered()), this, SLOT(Move()));
...
void MainWindow::CreateToolBars()
{
	...
	toolbar_file_->addAction(action_move_);
}
...
void MainWindow::Fill()
{
	...
	if (!window)
		return;
	window->imagewidget_->set_draw_status_to_fill();
	window->imagewidget_->set_source_window(child_source_);
}
...
void MainWindow::Move()
{
	...
	if (!window)
		return;
	window->imagewidget_->set_draw_status_to_move();
	window->imagewidget_->set_source_window(child_source_);
}
